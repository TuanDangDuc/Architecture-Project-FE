...
const testimonials = [
  {
    name: "Anh Minh",
    role: "Chủ đầu tư Biệt thự Quận 2",
    content:
      "Rất hài lòng với thiết kế tối giản nhưng vô cùng sang trọng. Đội ngũ làm việc chuyên nghiệp, đúng tiến độ.",
  },
  {
    name: "Chị Lan",
    role: "Chủ nhà phố Gò Vấp",
    content:
      "Không gian sống được tối ưu tuyệt vời. Ánh sáng tự nhiên ngập tràn, cảm giác rất ấm cúng và thoải mái.",
  },
];
      ...
      <section className="relative min-h-[90vh] py-24 flex items-center justify-center overflow-hidden bg-[var(--color-charcoal)]">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto flex flex-col items-center">
          <motion.div
            ...
            className="mb-8"
          >
            <Logo2 className="w-42 h-42 text-white mx-auto drop-shadow-lg" />
          </motion.div>
          ...
          >
            ...
            <span className="text-[var(--color-beige)] italic font-light text-3xl md:text-5xl mt-4 block drop-shadow-md">
              Kiến tạo không gian, Nâng tầm phong cách
            </span>
          </motion.h1>
          ...
          >
            Công Ty TNHH Mai Hương Architects mang đến những giải pháp thiết kế
            kiến trúc và nội thất tối giản, hiện đại, đậm dấu ấn cá nhân cho tổ
            ấm của bạn.
          </motion.p>
          ...
          >
            <Link
              to="/portfolio"
              className="px-8 py-4 bg-[var(--color-wood)] text-white font-medium rounded-full hover:bg-[var(--color-gold)] transition-all duration-300 w-full sm:w-auto text-center flex items-center justify-center shadow-lg hover:shadow-xl border border-transparent"
            >
              Về Chúng Tôi <ArrowRight size={18} className="ml-2" />
            </Link>
            <Link
              to="/projects"
              className="px-8 py-4 bg-white/10 backdrop-blur-md border border-white/30 text-white font-medium rounded-full hover:bg-white hover:text-[var(--color-wood)] transition-all duration-300 w-full sm:w-auto text-center shadow-md hover:shadow-lg"
            >
              Xem Dự Án
            </Link>
          </motion.div>
      ...
      <section className="py-24 bg-[var(--color-cream)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-[var(--color-wood)] mb-4">
            ...
            {services.map((service, index) => (
              ...
              >
                <div className="w-14 h-14 bg-[var(--color-beige)] rounded-full flex items-center justify-center mb-6 group-hover:bg-[var(--color-gold)] transition-colors">
                  <service.icon
                    size={28}
                    className="text-[var(--color-wood)] group-hover:text-white transition-colors"
                  />
                </div>
                <h3 className="text-xl font-serif font-semibold mb-3 text-[var(--color-charcoal)]">
                  {service.title}
                </h3>
      ...
      <section className="py-24 bg-[var(--color-beige)]/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-12">
            ...
            <Link
              to="/projects"
              className="hidden md:flex items-center text-[var(--color-wood)] font-medium hover:text-[var(--color-gold)] transition-colors group"
            >
              Xem tất cả{" "}
              <ArrowRight
                size={20}
                ...
                >
                  <Link to={`/projects/${project.id}`}>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center opacity-10 pointer-events-none z-10">
                      <span className="text-white font-serif font-black text-3xl md:text-4xl tracking-widest uppercase drop-shadow-lg rotate-[-30deg]">
                        MAI HUONG ARC
                      </span>
                    </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-white/90 text-lg mb-8 leading-relaxed font-light">
                Mỗi công trình là một tác phẩm nghệ thuật được chăm chút tỉ mỉ
                từ bản vẽ đến thực tế. Hãy cùng chúng tôi dạo bước qua những
                không gian sống đã được hiện thực hóa.
              </p>
              <ul className="space-y-4 mb-10">
                {[
                  "Thiết kế tinh tế, tối giản",
                  "Vật liệu cao cấp, bền vững",
                  "Thi công chuẩn xác 99% bản vẽ",
                ].map((item, i) => (
                  <li key={i} className="flex items-center text-white">
                    <CheckCircle2
                      size={20}
                      className="text-[var(--color-beige)] mr-3 shrink-0"
                    />
                    <span>{item}</span>
                  </li>
                ))}
              ...
              <Link
                to="/portfolio"
                className="inline-flex px-8 py-4 bg-[var(--color-beige)] text-[var(--color-charcoal)] font-medium rounded-full hover:bg-white transition-colors"
              >
                Khám phá thêm
              </Link>
            </div>
            ...
            <div className="relative aspect-video rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute inset-0 bg-black/20 flex items-center justify-center">
                <button className="w-20 h-20 bg-white/30 backdrop-blur-md rounded-full flex items-center justify-center hover:bg-[var(--color-gold)] hover:scale-110 transition-all duration-300 group cursor-pointer">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {testimonials.map((t, i) => (
              ...
              >
                <div className="text-6xl text-[var(--color-gold)] opacity-20 font-serif absolute top-6 left-6">
                  "
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <h4 className="font-bold text-[var(--color-wood)]">
                      {t.name}
                    </h4>
