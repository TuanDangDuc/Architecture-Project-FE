    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="w-64 bg-white border-r border-gray-200 flex flex-col">
        <div className="p-6 border-b border-gray-200">
          <h2 className="text-xl font-serif font-bold text-[var(--color-wood)]">
            Admin Panel
          </h2>
        </div>
                  ...
                  {projects.map((p: any) => (
                    ...
                    >
                      ...
                      <td className="p-4 text-right space-x-2">
                        <button
                          onClick={() =>
                            navigate("/admin/editor", { state: { project: p } })
                          }
                        ...
                        <button
                          onClick={() => openDeleteModal("project", p.id)}
                  ...
                  {posts.map((p: any) => (
                    ...
                    >
                      ...
                      <td className="p-4 text-right space-x-2">
                        ...
                        <button
                          onClick={() => openDeleteModal("post", p.id)}
                          className="p-2 text-red-600 hover:bg-red-50 rounded-lg transition-all duration-300 hover:scale-110 cursor-pointer"
                        >
                          <Trash2 size={18} />
                        </button>
                  ...
                  {videos.map((v: any) => (
                    ...
                    >
                      ...
                      <td className="p-4 text-right space-x-2">
                        ...
                        <button
                          onClick={() => openDeleteModal("video", v.id)}
                          className="p-2 text-red-600 hover:bg-red-50 rounded-lg transition-all duration-300 hover:scale-110 cursor-pointer"
                        >
                          <Trash2 size={18} />
                        </button>
            ...
            >
              ...
              <div className="flex gap-3 justify-center">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-red-600 text-white font-medium rounded-lg hover:bg-red-700 transition-colors shadow-sm cursor-pointer"
                >
                  Xóa ngay
                </button>
              </div>
              ...
              <div className="p-6 space-y-6">
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-800">
                      {selectedConsultation.email || "Không có"}
                    </p>
                  </div>
                </div>
