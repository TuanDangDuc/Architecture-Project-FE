...
export default function ProjectDetail() {
  ...
  if (!project || project.error) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[var(--color-cream)] text-[var(--color-wood)] font-serif text-2xl">
        Dự án không tồn tại
      </div>
    );
  }
    ...
    <div className="bg-[var(--color-cream)] min-h-screen pb-24 pt-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center mb-8 text-sm font-medium text-[var(--color-charcoal)]/60">
          <Link
            to="/projects"
            className="hover:text-[var(--color-gold)] transition-colors flex items-center"
          >
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap items-center gap-6 text-[var(--color-charcoal)]/70 font-medium">
            <div className="flex items-center">
              <Ruler size={18} className="mr-2 text-[var(--color-gold)]" />{" "}
              {project.area} m²
            </div>
            <div className="flex items-center">
              <DollarSign size={18} className="mr-2 text-[var(--color-gold)]" />{" "}
              {project.constructionCost || "Liên hệ"}
            </div>
            <div className="flex items-center">
              <Tag size={18} className="mr-2 text-[var(--color-gold)]" />{" "}
              {project.style}
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-3 mb-16">
          ...
          <div className="lg:flex-1 relative aspect-video rounded-2xl overflow-hidden bg-[var(--color-beige)] shadow-md group">
            ...
            <div className="absolute inset-0 flex items-center justify-center opacity-10 pointer-events-none z-10">
              <span className="text-white font-serif font-black text-4xl md:text-6xl tracking-widest uppercase drop-shadow-lg rotate-[-30deg]">
                MAI HUONG ARC
              </span>
            </div>
            <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
            <div className="bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-[var(--color-beige)]">
              <h2 className="text-2xl font-serif font-bold text-[var(--color-wood)] mb-6">
                Chi tiết dự án
              </h2>
              ...
              {project.content ? (
                ...
                project.description.includes("<style>") ? (
                ...
                <div className="prose prose-lg max-w-none text-[var(--color-charcoal)]/80 font-light leading-relaxed">
                  <p className="mb-6">
                    Dự án <strong>{project.name}</strong> là một tuyệt tác kiến
                    trúc mang đậm dấu ấn cá nhân, kết hợp hài hòa giữa công năng
                    sử dụng và thẩm mỹ tinh tế. Không gian được thiết kế mở, đón
                    trọn ánh sáng tự nhiên, tạo cảm giác thoáng đãng và gần gũi
                    với thiên nhiên.
                  </p>
                  <img
                  ...
                  <p className="mb-6">
                    Lấy cảm hứng từ phong cách {project.style}, đội ngũ kiến
                    trúc sư đã khéo léo sử dụng các vật liệu tự nhiên như gỗ, đá
                    kết hợp với kim loại hiện đại. Từng đường nét kiến trúc đều
                    được tính toán kỹ lưỡng để tối ưu hóa không gian sống, đồng
                    thời thể hiện đẳng cấp của gia chủ.
                  </p>
                  <img
                  ...
                  <p>
                    Mặt bằng công năng được bố trí khoa học, phân khu rõ ràng
                    nhưng vẫn đảm bảo sự kết nối xuyên suốt. Hệ thống cửa kính
                    lớn không chỉ giúp mở rộng tầm nhìn mà còn mang lại nguồn
                    năng lượng tích cực cho ngôi nhà mỗi ngày.
                  </p>
                </div>
              )}
            </div>
            ...
            {videos.length > 0 && (
              <div className="mt-16">
                <div className="flex items-center justify-between mb-8">
                  <h2 className="text-3xl font-serif font-bold text-[var(--color-wood)]">
                    Video Review Dự Án
                  </h2>
                    ...
                    return (
                      ...
                      >
                        ...
                        <h4 className="font-serif font-bold text-lg text-[var(--color-charcoal)] group-hover:text-[var(--color-gold)] transition-colors">
                          Khám phá không gian thực tế {project.name}{" "}
                          {videos.length > 1 ? `- Phần ${idx + 1}` : ""}
                        </h4>
            ...
            {!project.content &&
              !(
                ...
                <div className="bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-[var(--color-beige)] mt-12 relative overflow-hidden">
                  ...
                  <div className="prose prose-lg max-w-none text-[var(--color-charcoal)]/80 font-light leading-relaxed">
                    <h3 className="text-3xl font-serif font-bold text-[var(--color-wood)] mb-8">
                      Vật liệu & Thi công
                    </h3>
                    <p className="mb-6 text-xl leading-relaxed">
                      <span className="float-left text-6xl font-serif font-bold text-[var(--color-gold)] leading-none mr-3 mt-1">
                        Đ
                      </span>
                      ể hiện thực hóa bản vẽ thiết kế một cách hoàn hảo nhất,
                      chúng tôi đặc biệt chú trọng vào việc lựa chọn vật liệu và
                      quy trình thi công. Mọi chi tiết từ sàn nhà, ốp tường, đến
                      hệ thống ánh sáng đều được tuyển chọn từ những thương hiệu
                      uy tín, đảm bảo độ bền và tính thẩm mỹ cao nhất.
                    </p>
                    ...
                    <h3 className="text-3xl font-serif font-bold text-[var(--color-wood)] mt-8 mb-6">
                      Đánh giá từ gia chủ
                    </h3>
                    <blockquote className="border-l-4 border-[var(--color-gold)] pl-8 italic bg-[var(--color-cream)]/50 p-8 rounded-r-2xl my-8 relative">
                      <span className="absolute top-4 left-4 text-6xl text-[var(--color-gold)]/20 font-serif leading-none">
                        "
                      </span>
                      <p className="relative z-10 text-xl text-[var(--color-charcoal)]/90 leading-relaxed">
                        Tôi thực sự ấn tượng với sự chuyên nghiệp và tận tâm của
                        đội ngũ MAI HUONG ARC. Họ không chỉ lắng nghe mong muốn
                        của tôi mà còn đưa ra những giải pháp thiết kế vượt
                        ngoài mong đợi. Không gian sống mới mang lại cho gia
                        đình tôi cảm giác bình yên và tự hào mỗi khi đón khách.
                      </p>
                    ...
                    <p className="mb-10 text-lg">
                      Sự hài lòng của khách hàng chính là thước đo thành công
                      lớn nhất của chúng tôi. Mỗi dự án hoàn thành không chỉ là
                      một công trình kiến trúc, mà còn là một tổ ấm mang đậm dấu
                      ấn cá nhân, nơi lưu giữ những khoảnh khắc hạnh phúc của
                      gia đình.
                    </p>
                    ...
                    <div className="mt-12 pt-8 border-t border-[var(--color-beige)] flex flex-col sm:flex-row items-center justify-between gap-6">
                      ...
                      <Link
                        to="/projects"
                        className="inline-flex items-center px-8 py-4 bg-[var(--color-wood)] text-white font-medium rounded-full hover:bg-[var(--color-gold)] transition-all duration-300 shadow-md hover:shadow-lg"
                      >
          ...
          <div className="lg:col-span-1">
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-[var(--color-beige)] sticky top-28">
              <h3 className="text-xl font-serif font-bold text-[var(--color-wood)] mb-6 pb-4 border-b border-[var(--color-beige)]">
                Tóm tắt thông tin
              </h3>

              <ul className="space-y-5 mb-8">
                <li className="flex justify-between items-center py-2 border-b border-gray-50">
                  <span className="text-[var(--color-charcoal)]/60 flex items-center">
                    <Layers
                      size={16}
                ...
                <li className="flex justify-between items-center py-2 border-b border-gray-50">
                  <span className="text-[var(--color-charcoal)]/60 flex items-center">
                    <Tag size={16} className="mr-2 text-[var(--color-gold)]" />{" "}
                    Phong cách
                  </span>
                  <span className="font-medium text-[var(--color-charcoal)]">
                    {project.style}
              ...
              <div className="bg-[var(--color-cream)] p-6 rounded-2xl mb-6">
                <h4 className="font-bold text-[var(--color-wood)] mb-2">
                  Bạn thích dự án này?
                </h4>
                <p className="text-sm text-[var(--color-charcoal)]/70 mb-4">
                  Hãy để lại thông tin, chúng tôi sẽ tư vấn giải pháp tương tự
                  cho không gian của bạn.
                </p>
                <Link
                  to="/contact"
                  className="block w-full py-3 bg-[var(--color-wood)] text-white text-center font-medium rounded-xl hover:bg-[var(--color-gold)] transition-colors shadow-sm"
                >
                  Nhận tư vấn ngay
                </Link>
              </div>
              ...
              <a
                href="tel:0356210970"
                className="flex items-center justify-center w-full py-3 bg-white text-[var(--color-wood)] border border-[var(--color-wood)] text-center font-medium rounded-xl hover:bg-[var(--color-beige)] transition-colors"
              >
